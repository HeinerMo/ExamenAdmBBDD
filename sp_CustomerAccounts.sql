	...
	BEGIN TRY
		...
		SET @local_start = 0
			...
			BEGIN
				...
				END
					SET @SQL = @SQL + 'SELECT CUSTOMER_ACCOUNT_ID, CLIENT_ID, CUSTOMER_NAME, CUSTOMER_LAST_NAME, IS_DELETED, LAST_MODIFIED_DATE FROM CUSTOMERS.tb_CUSTOMER_ACCOUNTS WHERE CLIENT_ID = '+ ''''+CAST(@param_Client_Id AS NVARCHAR(10))+''''
			END
